...
def get_args_parser():
    ...
    parser.add_argument('--num_kp', default=8, type=int)
    ...
    # * HOI Detection
    parser.add_argument('--freeze_hoi', action='store_true', default=False)
    ...
    parser.add_argument('--project_name', default='GeoHOI_Project')
    parser.add_argument('--group_name', default='GeoHOI_Debug')
